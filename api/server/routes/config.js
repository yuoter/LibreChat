...
router.get('/', async function (req, res) {
  ...
  try {
    ...
    const payload = {
      ...
      defaultAgentsAvatar: appConfig?.defaultAgentsAvatar,
      ...
      successUrlForStripe: process.env.SUCCESS_URL_FOR_STRIPE,
      cancelUrlForStripe: process.env.CANCEL_URL_FOR_STRIPE,
      sharedLinksEnabled,
